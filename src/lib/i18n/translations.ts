...
const en = {
  ...
  'chat.subtitle': 'Tell Vincent about your dream trip and get a personalised itinerary in seconds.',
  'chat.placeholder': 'Tell me about your dream trip...',
  'chat.disclaimer': 'Vincent AI can make mistakes. Verify important travel details before booking.',
...
const es: Record<string, string> = {
  ...
  'chat.disclaimer': 'Vincent AI puede cometer errores. Verifica los detalles importantes antes de reservar.',
...
const fr: Record<string, string> = {
  ...
  'chat.disclaimer': 'Vincent AI peut faire des erreurs. Vérifiez les détails importants avant de réserver.',
